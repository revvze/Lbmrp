...
SWEP.Primary.RPM = 430 -- This is in Rounds Per Minute / RPM
...
--[[WORLDMODEL]]--
SWEP.WorldModel			= "models/weapons/tfa_bms/w_glock_bms.mdl" -- Weapon world model path
...
SWEP.IronSightsPos = Vector(-2.816, 0.2, 1.84)
...
SWEP.BlowbackVector = Vector(-0.025,-1.7,-0.025) --Vector to move bone <or root> relative to bone <or view> orientation.
SWEP.BlowbackCurrentRoot = 0 --Amount of blowback currently, for root
SWEP.BlowbackCurrent = 0 --Amount of blowback currently, for bones
SWEP.BlowbackBoneMods = {
	["ValveBiped.Bip01_Spine4"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, -0.186), angle = Angle(0, -2, 0) },
	["bone_gun"] = { scale = Vector(1, 1, 1), pos = Vector(0, 0, 0), angle = Angle(0, 2, 0) },
	["Bone01"] = { scale = Vector(1, 1, 1), pos = Vector(-1.297, 0, 0), angle = Angle(0, 2, 0) }
...
if killicon and killicon.Add then
	killicon.Add("tfa_bms_glock", "bms/vgui/icons/tfa_bms_glock", hudcolor)
end
