...
function PANEL:Init()
	...
	titleLabel:SetFont("BMRPTitleFont")
	...
	infoLabel2:SetText("Schema developed by "..Schema.author)
	...
	quit.DoClick = function()
		...
		Derma_Query(table.Random(disconnectQuotes), "Quit", "Disconnect", function()
			self:SlideDown(1, function()
